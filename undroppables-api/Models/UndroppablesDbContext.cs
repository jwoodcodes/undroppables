...
public partial class UndroppablesDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("AllPlayerData_pkey");
            ...
            entity.Property(e => e.Pnodvscore).HasColumnName("PNODVScore");
            entity.Property(e => e.Position).HasColumnName("position");
            entity.Property(e => e.ProjectedNextOffseasonDynastyValue)
                .HasColumnType("jsonb")
                .HasColumnName("projectedNextOffseasonDynastyValue");
            entity.Property(e => e.Prpscore).HasColumnName("PRPScore");
            entity.Property(e => e.RawData)
                .HasColumnType("jsonb")
                .HasColumnName("rawData");
            entity.Property(e => e.Rvsscore).HasColumnName("RVSScore");
            entity.Property(e => e.Team).HasColumnName("team");
            entity.Property(e => e.TradeAnalyzerDataObjectsArray)
                .HasColumnType("jsonb")
                .HasColumnName("tradeAnalyzerDataObjectsArray");
            entity.Property(e => e.ValueDiffBetweenMyValueAndMarketValue).HasColumnName("valueDiffBetweenMyValueAndMarketValue");
            entity.Property(e => e.ValueDifferenceBetweenCurrentMarketValueAndPnodv).HasColumnName("valueDifferenceBetweenCurrentMarketValueAndPNODV");
        });
...
*/
        ...
        {
            entity.HasKey(e => e.Id).HasName("SleeperPlayer_pkey");

            entity.ToTable("SleeperPlayer");
        ...
        modelBuilder.Entity<TradeAnalyzerDatum>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("tradeAnalyzerData_pkey");

            entity.ToTable("tradeAnalyzerData");

            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.ConsensusValue).HasColumnName("consensusValue");
            entity.Property(e => e.JaxValue).HasColumnName("jaxValue");
            entity.Property(e => e.JoeValue).HasColumnName("joeValue");
            entity.Property(e => e.MarketValue).HasColumnName("marketValue");
            entity.Property(e => e.MyValue).HasColumnName("myValue");
            entity.Property(e => e.Name).HasColumnName("name");
            entity.Property(e => e.Pnodvscore).HasColumnName("PNODVScore");
            ...
            entity.Property(e => e.Rvsscore).HasColumnName("RVSScore");
            entity.Property(e => e.Team).HasColumnName("team");
            entity.Property(e => e.TravValue).HasColumnName("travValue");
            entity.Property(e => e.ValueDiffBetweenMyValueAndMarketValue).HasColumnName("valueDiffBetweenMyValueAndMarketValue");
            entity.Property(e => e.ValueDifferenceBetweenCurrentMarketValueAndPnodv).HasColumnName("valueDifferenceBetweenCurrentMarketValueAndPNODV");
        });

        modelBuilder.Entity<UnscorePlayer>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("UNScorePlayer_pkey");

            entity.ToTable("UNScorePlayer");

            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.CareerAveragedStats)
                .HasColumnType("jsonb")
                .HasColumnName("careerAveragedStats");
            entity.Property(e => e.CareerSlotPercentage).HasColumnName("careerSlotPercentage");
            entity.Property(e => e.CareerWidePercentage).HasColumnName("careerWidePercentage");
            ...
            entity.Property(e => e.HighestContestedTargetPercent).HasColumnName("highestContestedTargetPercent");
            entity.Property(e => e.Name).HasColumnName("name");
            entity.Property(e => e.RawData)
                .HasColumnType("jsonb")
                .HasColumnName("rawData");
            entity.Property(e => e.TopModelComps)
                .HasColumnType("jsonb")
                .HasColumnName("topModelComps");
            entity.Property(e => e.UnScore).HasColumnName("unScore");
